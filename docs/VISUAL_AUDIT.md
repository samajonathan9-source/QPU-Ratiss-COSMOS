...
Le panneau inférieur conserve ensemble le taux ETH de la baseline, la tension de tryperposition du scénario de sensibilité et son seuil paramétré. Les deux échelles restent lisibles, les légendes ne recouvrent pas les données et les différences de trajectoire ne sont pas lissées.
